...
function EditItem() {
  ...
  const [isSubscription, setIsSubscription] = useState(currentItem?.isSubscription || false);
  const [mealsPerWeek, setMealsPerWeek] = useState(currentItem?.mealsPerWeek || 0);
  const [mealsPerMonth, setMealsPerMonth] = useState(currentItem?.mealsPerMonth || 0);
  const [validityDays, setValidityDays] = useState(currentItem?.validityDays || 0);
  ...
  if (!currentItem) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: "linear-gradient(135deg, #fff7ed 0%, #ffffff 50%, #fefce8 100%)" }}>
    ...
    >
      <div className="w-full max-w-2xl">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-400 text-sm mt-2">Update your dish details below</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-orange-100 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-10 flex flex-col gap-6">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-xs text-gray-400">Click to change item image</span>
            </div>
            ...
            >
              {loading ? "Saving..." : success ? "✓ Updated! Redirecting..." : "Update Item"}
            </button>
